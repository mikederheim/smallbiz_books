...
require __DIR__ . '/../app/Core/AuditTrail.php';
require __DIR__ . '/../app/Core/PeriodLock.php';
...
$transactionRoutes = ['invoice_new','invoice_edit','invoice_save','invoice_update','invoice_delete','invoice_pay','bill_new','bill_edit','bill_save','bill_update','bill_delete','bill_pay','journal_new','journal_edit','journal_save','journal_update','journal_delete','reconcile_start','reconcile_save','reconcile_delete','period_close','period_unlock'];
$reportRoutes = ['reports_pl','reports_bs','reports_customer','reports_vendor','audit_trail'];
...
$map = [
 ...
 'accounts'=>['AccountController','index'], 'account_save'=>['AccountController','save'], 'account_register'=>['AccountController','register'],
 'customers'=>['CustomerController','index'], 'customer_new'=>['CustomerController','create'], 'customer_save'=>['CustomerController','save'], 'customer_edit'=>['CustomerController','edit'], 'customer_update'=>['CustomerController','update'], 'customer_delete'=>['CustomerController','delete'],
 'vendors'=>['VendorController','index'], 'vendor_new'=>['VendorController','create'], 'vendor_save'=>['VendorController','save'], 'vendor_edit'=>['VendorController','edit'], 'vendor_update'=>['VendorController','update'], 'vendor_delete'=>['VendorController','delete'],
 ...
 'audit_trail'=>['AuditController','index'], 'periods'=>['PeriodController','index'], 'period_close'=>['PeriodController','close'], 'period_unlock'=>['PeriodController','unlock'],
